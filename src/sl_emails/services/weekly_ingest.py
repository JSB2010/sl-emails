...
from sl_emails.domain.weekly import default_audience_copy_overrides, default_copy_overrides, default_delivery_state
...
def _build_source_payload(
    *,
    ...
    copy_overrides_by_audience: dict[str, dict[str, str]],
    ...
    return (
        {
            ...
            "copy_overrides_by_audience": copy_overrides_by_audience,
...
def source_refresh_week(store: WeeklyEmailStore, week_id: str) -> WeeklyIngestResult:
    ...
    if existing is not None:
        ...
        copy_overrides_by_audience = {audience: dict(copy) for audience, copy in existing.copy_overrides_by_audience.items()}
